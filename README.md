...
- [canack/nats-header-problem](https://github.com/canack/nats-header-problem) - The example code that gives panic (3 weeks ago)
...
- [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) ([v1.1.2](https://github.com/charmbracelet/bubbletea/releases/tag/v1.1.2), 2 days ago) - A powerful little TUI framework 🏗
- [Permify/permify](https://github.com/Permify/permify) ([v1.1.7](https://github.com/Permify/permify/releases/tag/v1.1.7), 4 days ago) - An open-source authorization as a service inspired by Google Zanzibar, designed to build and manage fine-grained and scalable authorization systems for any application.
...
- [kondukto-io/kdt](https://github.com/kondukto-io/kdt) ([v1.0.35.1](https://github.com/kondukto-io/kdt/releases/tag/v1.0.35.1), 2 weeks ago) - CLI to interact with Kondukto
- [bayraktugrul/modview](https://github.com/bayraktugrul/modview) ([v1.2.2](https://github.com/bayraktugrul/modview/releases/tag/v1.2.2), 2 weeks ago) - Effortlessly visualize mod graph with all external dependencies for your Go projects
