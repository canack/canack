...
- [Permify/permify](https://github.com/Permify/permify) ([v1.3.1](https://github.com/Permify/permify/releases/tag/v1.3.1), 3 days ago) - An open-source authorization as a service inspired by Google Zanzibar, designed to build and manage fine-grained and scalable authorization systems for any application.
...
- [workflowkit/issue-assistant](https://github.com/workflowkit/issue-assistant) ([v1.0.0](https://github.com/workflowkit/issue-assistant/releases/tag/v1.0.0), 4 weeks ago) - 
