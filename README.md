...
- [kondukto-io/kdt](https://github.com/kondukto-io/kdt) ([v1.40.1](https://github.com/kondukto-io/kdt/releases/tag/v1.40.1), today) - CLI to interact with Kondukto
- [Permify/permify](https://github.com/Permify/permify) ([v1.2.9](https://github.com/Permify/permify/releases/tag/v1.2.9), 6 days ago) - An open-source authorization as a service inspired by Google Zanzibar, designed to build and manage fine-grained and scalable authorization systems for any application.
