...
- [zed-industries/zed](https://github.com/zed-industries/zed) ([v0.222.0-pre](https://github.com/zed-industries/zed/releases/tag/v0.222.0-pre), today) - Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
- [kondukto-io/kdt](https://github.com/kondukto-io/kdt) ([v1.45.0](https://github.com/kondukto-io/kdt/releases/tag/v1.45.0), 1 day ago) - CLI to interact with Kondukto
