...
- [nats-io/nats.go](https://github.com/nats-io/nats.go) ([v1.40.0](https://github.com/nats-io/nats.go/releases/tag/v1.40.0), today) - Golang client for NATS, the cloud native messaging system.
