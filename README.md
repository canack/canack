...
- [termkit/gama](https://github.com/termkit/gama) - Manage your GitHub Actions from Terminal with great UI 🧪 (9 months ago)

#### 🔥 Latest releases I've contributed to

- [zed-industries/zed](https://github.com/zed-industries/zed) ([v0.224.4-pre](https://github.com/zed-industries/zed/releases/tag/v0.224.4-pre), 1 day ago) - Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
