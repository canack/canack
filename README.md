...
- [canack/huesmith](https://github.com/canack/huesmith) ([v0.1.0](https://github.com/canack/huesmith/releases/tag/v0.1.0), today) - Turn a ~$10 ESP32 into a smart light that pairs directly with your Philips Hue Bridge — no cloud, no hub. A Rust library. 💡
- [zed-industries/zed](https://github.com/zed-industries/zed) ([v1.10.0](https://github.com/zed-industries/zed/releases/tag/v1.10.0), today) - Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
