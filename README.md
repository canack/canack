...
- [kondukto-io/kdt](https://github.com/kondukto-io/kdt) ([v1.0.36](https://github.com/kondukto-io/kdt/releases/tag/v1.0.36), today) - CLI to interact with Kondukto
- [Permify/permify](https://github.com/Permify/permify) ([v1.2.1](https://github.com/Permify/permify/releases/tag/v1.2.1), today) - An open-source authorization as a service inspired by Google Zanzibar, designed to build and manage fine-grained and scalable authorization systems for any application.
