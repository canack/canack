...
- [bayraktugrul/modview](https://github.com/bayraktugrul/modview) ([v1.2.4](https://github.com/bayraktugrul/modview/releases/tag/v1.2.4), 1 day ago) - Effortlessly visualize mod graph with all external dependencies for your Go projects
- [Permify/permify](https://github.com/Permify/permify) ([v1.2.3](https://github.com/Permify/permify/releases/tag/v1.2.3), 4 days ago) - An open-source authorization as a service inspired by Google Zanzibar, designed to build and manage fine-grained and scalable authorization systems for any application.
