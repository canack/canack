...
- [Permify/permify](https://github.com/Permify/permify) ([v1.2.2](https://github.com/Permify/permify/releases/tag/v1.2.2), 2 days ago) - An open-source authorization as a service inspired by Google Zanzibar, designed to build and manage fine-grained and scalable authorization systems for any application.
...
- [kondukto-io/kdt](https://github.com/kondukto-io/kdt) ([v1.0.37](https://github.com/kondukto-io/kdt/releases/tag/v1.0.37), 3 days ago) - CLI to interact with Kondukto
