...
- [vmware-tanzu/secrets-manager](https://github.com/vmware-tanzu/secrets-manager) - VMware Secrets Manager is a lightweight secrets manager to protect your sensitive data. It’s perfect for edge deployments where energy and footprint requirements are strict—See more: https://vsecm.com/ (3 days ago)
...
- [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea) ([v1.1.0](https://github.com/charmbracelet/bubbletea/releases/tag/v1.1.0), 1 day ago) - A powerful little TUI framework 🏗
- [Permify/permify](https://github.com/Permify/permify) ([v1.0.4](https://github.com/Permify/permify/releases/tag/v1.0.4), 4 days ago) - An open-source authorization as a service inspired by Google Zanzibar, designed to build and manage fine-grained and scalable authorization systems for any application.
- [termkit/skeleton](https://github.com/termkit/skeleton) ([v0.1.0](https://github.com/termkit/skeleton/releases/tag/v0.1.0), 5 days ago) - The Multi-tab framework of Bubbletea programs!
