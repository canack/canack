...
- [kondukto-io/kdt](https://github.com/kondukto-io/kdt) ([v1.0.33](https://github.com/kondukto-io/kdt/releases/tag/v1.0.33), 4 days ago) - CLI to interact with Kondukto
...
- [Live mode](https://github.com/termkit/gama/pull/65) on [termkit/gama](https://github.com/termkit/gama) (6 days ago)
...
- [mediremi/rust-plus-golang](https://github.com/mediremi/rust-plus-golang) - Rust &#43; Go — Call Rust code from Go using FFI (3 days ago)
- [VadzimBelski-ScienceSoft/go-call-rust-ffi](https://github.com/VadzimBelski-ScienceSoft/go-call-rust-ffi) - This is a sample how to use effectively FFI on Go and Rust (4 days ago)
