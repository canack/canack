...
- [nats-io/nats.go](https://github.com/nats-io/nats.go) ([v1.42.0](https://github.com/nats-io/nats.go/releases/tag/v1.42.0), 4 weeks ago) - Golang client for NATS, the cloud native messaging system.
