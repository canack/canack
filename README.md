...
- [kondukto-io/kdt](https://github.com/kondukto-io/kdt) - CLI to interact with Kondukto (3 days ago)
...
- [kondukto-io/kdt](https://github.com/kondukto-io/kdt) ([v1.0.35.1](https://github.com/kondukto-io/kdt/releases/tag/v1.0.35.1), 1 day ago) - CLI to interact with Kondukto
- [Permify/permify](https://github.com/Permify/permify) ([v1.1.3](https://github.com/Permify/permify/releases/tag/v1.1.3), 4 days ago) - An open-source authorization as a service inspired by Google Zanzibar, designed to build and manage fine-grained and scalable authorization systems for any application.
- [bayraktugrul/modview](https://github.com/bayraktugrul/modview) ([v1.2.2](https://github.com/bayraktugrul/modview/releases/tag/v1.2.2), 5 days ago) - Effortlessly visualize mod graph with all external dependencies for your Go projects
