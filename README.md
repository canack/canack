...
- [Permify/permify](https://github.com/Permify/permify) ([v1.3.0](https://github.com/Permify/permify/releases/tag/v1.3.0), 6 days ago) - An open-source authorization as a service inspired by Google Zanzibar, designed to build and manage fine-grained and scalable authorization systems for any application.
