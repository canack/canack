...
- [Permify/permify](https://github.com/Permify/permify) ([v1.1.0](https://github.com/Permify/permify/releases/tag/v1.1.0), 1 day ago) - An open-source authorization as a service inspired by Google Zanzibar, designed to build and manage fine-grained and scalable authorization systems for any application.
- [kondukto-io/kdt](https://github.com/kondukto-io/kdt) ([v1.0.34.1](https://github.com/kondukto-io/kdt/releases/tag/v1.0.34.1), 1 day ago) - CLI to interact with Kondukto
