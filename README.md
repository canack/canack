...
- [Permify/permify](https://github.com/Permify/permify) ([v1.1.7](https://github.com/Permify/permify/releases/tag/v1.1.7), today) - An open-source authorization as a service inspired by Google Zanzibar, designed to build and manage fine-grained and scalable authorization systems for any application.
